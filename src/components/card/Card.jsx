  ...
  return (
    <div className="rounded-md w-full md:max-w-md lg:max-w-xl">
      ...
      <div className="mt-6 font-RH">
        <Title as="h3" className="text-sm font-RH text-rose-300">
          {product.category}
        </Title>
        <Title
          as="h2"
          className="text-base font-semibold text-rose-900 hover:text-rose-700 transition-colors duration-300"
        >
          {product.name}
        </Title>
        <Title as="h4" className="text-sm font-semibold text-primary">
